            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <img src="/productimage/shop1.jpg " class="pb-1 w-100 bg-transparent" style="height:80px">
                        </a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                        <li class="scroll-to-section"><a href="{{url('/')}}" >Home</a></li>
                            <li class="scroll-to-section"><a  class="active" href="{{url('/about')}}">About Us</a></li>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="first-item">
                        ...
                        <ul>
                            ...
                            <li><a href="#">exemple@exemple.com</a></li>
                ...
                <div class="col-lg-12">
                    <div class="under-footer">
                        <p>Copyright © 2022 SOUFIANE CH,  All Rights Reserved.</p>
